                        ...
                        <form role="form">
                            <fieldset>
                                <div class="form-group">
                                   ...
                                   <input class="form-control" placeholder="Ingrese Email" id="login-email" name="email" value="rodrigueznicolas.9319@gmail.com" type="email" autofocus="" maxlength="18" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Contraseña <a href="LINK A OLVIDE CONTRASEÑA">(Olvide mi contraseña)</a></label>
                                    <input class="form-control" value="123456" placeholder="Contraseña" id="login-pass" name="password" type="password" value="" maxlength="18" required>
                                </div>
                                <div class="checkbox">
                                    <label>
